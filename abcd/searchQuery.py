...
def run_spark_job(selected_table=None, column_names=None,search_label=None):
    ...
    # spark-submit --master spark://spark-master:7077 --packages com.datastax.spark:spark-cassandra-connector_2.12:3.2.0 /opt/shared/SearchQuery.py --selected_table department --column_names iddepartment --search_label KT

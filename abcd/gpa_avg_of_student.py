...
def run_spark_job(selected_class=None):
    try:
        ...
        command = f"docker exec -it spark-master bash -c \"spark-submit --master spark://spark-master:7077 --packages com.datastax.spark:spark-cassandra-connector_2.12:3.2.0 /opt/shared/GPA_avg_of_student_in_class.py --selected_class {selected_class} \""
